...
async function clearDatabase() {
  try {
    ...
    console.log("All leaderboards deleted");
...
async function insertCharacters() {
  ...
  if (!image) {
    console.error("Image 'Cyberpunk City' not found");
    throw new Error("Required image not found for inserting characters");
  }
...
async function insertCharacters2ndImage() {
  ...
  if (!image) {
    console.error("Image 'Universe 113' not found");
    throw new Error("Required image not found for inserting characters");
  }
...
async function insertCharacters3rdImage() {
  ...
  if (!image) {
    console.error("Image 'Universe 113 Infested' not found");
    throw new Error("Required image not found for inserting characters");
  }
